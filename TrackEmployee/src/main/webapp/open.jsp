...
<%-- 		<c:forEach var="emp" items="${listEmp}" varStatus="status"> --%>
			<div id="details">
				<label id="idLabel">ID :</label> <input id="id" type="number"
					name="id" value=${listEmp.id}> <label id="nameLabel">Name
					:</label> <input id="name" type="text" name="name" value=${listEmp.name}> <label
					id="dojLabel">Date of Joining :</label> <input id="doj" type="text"
					name="doj" value=${listEmp.doj}> <label id="noiLabel">Number of
					Interviews Scheduled :</label> <input id="noi" type="number"
					name="numberOfInterviewsScheduled" value=${listEmp.numberOfInterviewsScheduled}> <label id="uiLabel">Upcoming
					Interviews scheduled :</label> <input id="ui" type="text"
